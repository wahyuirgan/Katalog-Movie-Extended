...
public class MyMovieAdapter extends RecyclerView.Adapter<MyMovieAdapter.ViewHolder> {
    ...
    public void setMovieItems(ArrayList<MovieList> items){
        this.mMovieItem = items;
    }

    public MyMovieAdapter(final Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.movie_models, parent, false);
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            ...
            tglrilis =  itemView.findViewById(R.id.rilis);
        }
